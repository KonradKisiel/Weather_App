    ...
    },
    {
        ...
        value: function renderControls() {
            ...
            return _react2.default.createElement(
                ...
                _react.Children.map(this.props.children, function (item, index) {
                    return _react2.default.createElement('li', { className: _cssClasses2.default.DOT(index === _this3.state.selectedItem), onClick: _this3.changeItem, onKeyDown: _this3.changeItem, value: index, key: index, role: 'button', tabIndex: 0 });
                })
            );
        }
    }, {
        ...
        value: function renderItems(isClone) {
            ...
            return _react.Children.map(this.props.children, function (item, index) {
                var slideProps = {
                    ref: function ref(e) {
                        return _this4.setItemsRef(e, index);
                    },
                    key: 'itemKey' + index + (isClone ? 'clone' : ''),
                    className: _cssClasses2.default.ITEM(true, index === _this4.state.selectedItem),
                    onClick: _this4.handleClickItem.bind(_this4, index, item)
                };

                if (_this4.props.centerMode && _this4.props.axis === 'horizontal') {
                    slideProps.style = {
                        minWidth: _this4.props.centerSlidePercentage + '%'
                    };
                }
