...
const WeatherInfo = (props) => {
    ...
    return (
        <div className="container360">
            ...
            <div id="mainTemp">
                <h1 id="tempBig">{Math.floor(temperature)}<img className="weatherIcon" src={icon} alt="weather icon" /><span id="tempUnit">{units === "metric" ? "C" : "F"}</span></h1>
            </div>
            <div id="riseSet">
            ...
            <div className="infoBar">
                ...
                <div>
                    <p>
                        ...
                        {wind_speed}<span> {units === "metric" ? "m/s" : "mph"}</span>
                    </p>
                </div>
                {/*
                              <div>
